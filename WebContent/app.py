...
def account():
    ...
    """
    showList = c.Shows.query.with_entities(c.Shows.idShows, c.Shows.show, c.Shows.start_date, c.Shows.end_date, c.Shows.client, c.Shows.job_type, c.Shows.status, c.Shows.handler, c.Shows.salesperson, c.Shows.created_by)
